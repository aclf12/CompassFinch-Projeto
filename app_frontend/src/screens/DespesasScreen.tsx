...
export default function DespesasScreen({ navigation }: any) {
  ...
  useEffect(() => {
    async function carregarCategorias() {
      try {
        ...
        // Filtramos APENAS as categorias do tipo 'despesa'
        const saidas = resposta.data.filter((c: any) => c.tipo === 'despesa');
  ...
  const salvarDespesa = async () => {
    ...
    try {
      ...
      await api.post('/transacoes', novaDespesa);
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTitleContainer}>
            <Ionicons name="compass-outline" size={32} color="#00FF4D" style={{ marginRight: 10 }} />
        ...
        <View style={styles.formContainer}>
          ...
          {/* O MENU DROP-DOWN DE CATEGORIAS DE SAÍDA */}
          <View>
            <TouchableOpacity 
              ...
              <View style={styles.dropdownContent}>
                ...
                {categorias.length > 0 ? (
                  ...
                  <View style={styles.emptyContainer}>
                    <Text style={styles.emptyText}>Sem categorias de despesa.</Text>
                  </View>
                )}
                ...
                <TouchableOpacity 
                  ...
                  onPress={() => {
                    alternarMenu();
                    navigation.navigate('AddCategoriaScreen'); 
                  }}
                >
        ...
        <View style={styles.footer}>
          <CustomButton title="Confirmar Despesa" onPress={salvarDespesa} />
        </View>
